...
function main()
    ...
    #grasp_parameters = [0.003, 0.01, 0.012, 0.014, 0.017, 0.018, 0.02, 0.03] #, 0.023, 0.025, 0.028, 0.032, 0.038] 

    grasp_type = 3
    grasp_parameters = [[0.025, 0.001], [0.0375, 0.001], [0.05, 0.001], [0.025, 0.006], 
