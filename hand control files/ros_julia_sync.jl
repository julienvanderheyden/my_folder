...
function main()
    ...
    grasp_parameters = [0.008, 0.008, 0.008, 0.008, 0.008, 0.008, 0.008, 0.008, 0.008] #, 0.023, 0.025, 0.028, 0.032, 0.038] 

    #grasp_type = 3
    #grasp_parameters = [[0.025, 0.005], [0.025, 0.005], [0.025, 0.005], [0.025, 0.005], 
    #[0.025, 0.005], [0.025, 0.005], [0.025, 0.005], [0.025, 0.005], [0.025, 0.005]]
