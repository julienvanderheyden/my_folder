...
add_component!(vms, LinearSpring(10.0, "th j4 angle error"); id="th j4 angular spring")
add_component!(vms, LinearDamper(0.01, "th j4 angle error"); id="th j4 angular damper")
