...
stiffness_modifier = 0.0 # stiffness_modifier = 1.0 corresponds to multiplying all stiffnesses by 2
...
function object_centric_medium_wrap(cylinder_radius)
    ...
    th_massive_damping = (1+damping_modifier) * 10.0
    add_component!(vms, LinearDamper(SMatrix{3, 3}(th_massive_damping, 0., 0., 0., th_massive_damping, 0., 0., 0., th_massive_damping), "ee thmiddle diff"); id = "thmiddle massive damper")
...
function object_centric_power_sphere(ball_radius)
    ...
    base_damping = (1 +damping_modifier) * 0.15
    D = SMatrix{3, 3}(base_damping, 0., 0., 0., base_damping, 0., 0., 0., base_damping)
    ...
    if ball_radius <= 0.033
        ...
        thumb_tip_damping = (1+damping_modifier) * 0.15
    ...
    base_angular_stiffness = (1+stiffness_modifier) * 0.001
    base_angular_damping = (1+damping_modifier) * 0.001
    ...
    add_component!(vms, LinearSpring(base_angular_stiffness, "ff mf j4 angular error"); id="ff mf angular spring")
    add_component!(vms, LinearDamper(base_angular_damping, "ff mf j4 angular error"); id="ff mf angular damper")
    ...
    add_component!(vms, LinearSpring(base_angular_stiffness, "mf rf j4 angular error"); id="mf rf angular spring")
    add_component!(vms, LinearDamper(base_angular_damping, "mf rf j4 angular error"); id="mf rf angular damper")
    ...
    add_component!(vms, LinearSpring(base_angular_stiffness, "rf lf j4 angular error"); id="rf lf angular spring")
    add_component!(vms, LinearDamper(base_angular_damping, "rf lf j4 angular error"); id="rf lf angular damper")
    ...
    add_component!(vms, LinearSpring(base_angular_stiffness, "th j4 error"); id="th j4 spring")
...
function object_centric_lateral_pinch(box_width, box_thickness)
    ...
    th_massive_damping = (1+damping_modifier) * 1.0
    add_component!(vms, LinearDamper(SMatrix{3, 3}(th_massive_damping, 0., 0., 0., th_massive_damping, 0., 0., 0., th_massive_damping), "ee thdistal diff"); id = "ee thdistal mass damper")
