...
function object_centric_lateral_pinch(box_width, box_thickness)
    ...
    for i in 1:length(attracted_frames)
        ...
        add_joint!(vm_robot, Prismatic(SVector(1.0,0.0,0.0)); parent="base_frame_$(attracted_frames_names[i])", child="prism_frame_1_$(attracted_frames_names[i])", id="prism_joint_1_$(attracted_frames_names[i])")
        add_frame!(vm_robot; id="prism_frame_2_$(attracted_frames_names[i])")
        add_joint!(vm_robot, Prismatic(SVector(0.0,1.0,0.0)); parent="prism_frame_1_$(attracted_frames_names[i])", child="prism_frame_2_$(attracted_frames_names[i])", id="prism_joint_2_$(attracted_frames_names[i])")
        ...
        add_component!(vm_robot, PointMass(1., "$(attracted_frames_names[i]) ee position"); id="$(attracted_frames_names[i]) ee mass")
        add_coordinate!(vm_robot, FrameOrigin("prism_frame_1_$(attracted_frames_names[i])"); id="$(attracted_frames_names[i]) prism 1 position")
        add_component!(vm_robot, PointMass(1., "$(attracted_frames_names[i]) prism 1 position"); id="$(attracted_frames_names[i]) prism 1 mass")
        add_coordinate!(vm_robot, FrameOrigin("prism_frame_2_$(attracted_frames_names[i])"); id="$(attracted_frames_names[i]) prism 2 position")
        add_component!(vm_robot, PointMass(1., "$(attracted_frames_names[i]) prism 2 position"); id="$(attracted_frames_names[i]) prism 2 mass")
        ...
        add_coordinate!(vm_robot, JointSubspace("prism_joint_3_$(attracted_frames_names[i])"); id="prism_joint_3_$(attracted_frames_names[i])")
        add_component!(vm_robot, LinearDamper(joint_damping, "prism_joint_3_$(attracted_frames_names[i])"); id="prism_joint_3_$(attracted_frames_names[i])_damper")
    ...
    add_component!(vms, LinearSpring(0.05, "th distal y diff"); id = "th distal y spring")
    ...
    repulsed_frames = (".virtual_mechanism.rh_fftip_mass_coord", ".virtual_mechanism.rh_ffmiddle_mass_coord", ".virtual_mechanism.rh_ffproximal_mass_coord", ".virtual_mechanism.rh_fftip", 
                        ".virtual_mechanism.rh_ffmiddle", ".virtual_mechanism.rh_ffproximal", ".virtual_mechanism.rh_thtip", ".virtual_mechanism.rh_thdistal", ".virtual_mechanism.rh_thdistal_mass_coord", ".virtual_mechanism.rh_thproximal_mass_coord")
