...
for joint_id in keys(joints(vm_robot))
    ...
    add_deadzone_springs!(vm_robot, 0.1, (limits.lower+0.1, limits.upper-0.1), "$(joint_id)_coord")
...
add_component!(vms, LinearSpring(0.00001, ".virtual_mechanism.rh_FFJ3_coord"); id = "ff j3 angular spring")
